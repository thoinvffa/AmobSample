...
public class RewardedInterstitialActivity extends AppCompatActivity {
    ...
    private void loadRewardedInterstitialAd() {
        if (rewardedInterstitialAd == null) {
            ...
            RewardedInterstitialAd.load(
                    RewardedInterstitialActivity.this,
                    AD_UNIT_ID,
                    adRequest,
                    new RewardedInterstitialAdLoadCallback() {
                        ...
                        public void onAdLoaded(RewardedInterstitialAd ad) {
                            ...
                            isLoadingAds = false;
                            Toast.makeText(RewardedInterstitialActivity.this, "onAdLoaded", Toast.LENGTH_SHORT).show();
                        }
                        ...
                        public void onAdFailedToLoad(LoadAdError loadAdError) {
                            ...
                            isLoadingAds = false;
                            Toast.makeText(RewardedInterstitialActivity.this, "onAdFailedToLoad", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
    ...
    private void showRewardedVideo() {
        ...
        rewardedInterstitialAd.setFullScreenContentCallback(
                new FullScreenContentCallback() {
                    ...
                    public void onAdShowedFullScreenContent() {
                        ...
                        Toast.makeText(RewardedInterstitialActivity.this, "onAdShowedFullScreenContent", Toast.LENGTH_SHORT)
                                .show();
                    }
                    ...
                    public void onAdFailedToShowFullScreenContent(AdError adError) {
                        ...
                        Toast.makeText(
                                RewardedInterstitialActivity.this, "onAdFailedToShowFullScreenContent", Toast.LENGTH_SHORT)
                                .show();
                    }
                    ...
                    public void onAdDismissedFullScreenContent() {
                        ...
                        Toast.makeText(RewardedInterstitialActivity.this, "onAdDismissedFullScreenContent", Toast.LENGTH_SHORT)
                                .show();
        ...
        Activity activityContext = RewardedInterstitialActivity.this;
